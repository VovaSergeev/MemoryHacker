...
public class Shop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currency = sharedPreferences.getInt("currency", 100);
    ...
    private void createSkins() {
        skins = new ArrayList<>();
        skins.add(new Skin(R.drawable.fruiet, "Скин 1", 0));
        skins.add(new Skin(R.drawable.attake_on_titan, "Скин 2", 0));
        skins.add(new Skin(R.drawable.medium, "Скин 3", 0));
    }
