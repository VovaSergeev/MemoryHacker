...
public class GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mySong.start();
        time = getIntent().getStringExtra("time");//  в бд

        skinIndex= getIntent().getIntExtra("selectedSkinIndex", skinIndex);
        System.out.println(time+" "+difficulty+" "+skinIndex);



        difficulty = getIntent().getStringExtra("difficulty");// в бд
        ...
        imageResources.add(R.drawable.mrbeast);
        ...
        binding.countGallery.setImageResource(R.drawable.mrbeast);
        ...
        binding.closeAdButton.setOnClickListener(v -> {

            binding.adContainer.setVisibility(android.view.View.GONE);
        });
        binding.botoon1.setOnClickListener(v -> {
            ...
            @SuppressLint("UnsafeIntentLaunch") Intent intent = FinishActivity.getIntent(this,galleryCount,cameraCount,manageCount,shareCount,callCount,compassCount,number1,number2,number3,number4,number5,number6);
